...
![](https://github.com/eriklarsen4/Endo/blob/main/vignettes/Full Scatter-1.png)<!-- -->
...
![](https://github.com/eriklarsen4/Endo/blob/main/vignettes/vATPase Scatter zoom-1.png)<!-- -->
...
```
![](https://github.com/eriklarsen4/Endo/blob/main/vignettes/Macro zoom-1.png)<!-- -->
...
```
![](https://github.com/eriklarsen4/Endo/blob/main/vignettes/IC transport zoom-1.png)<!-- -->
...
```
![](https://github.com/eriklarsen4/Endo/blob/main/vignettes/GO Bar Plot-1.png)<!-- -->
...
GO_info_by_term_df_sig |> 
  ...
  geom_text(aes(label = sig,
            ...
            alpha = 1)
```
![](https://github.com/eriklarsen4/Endo/blob/main/vignettes/GO CC Bar Plot-1.png)<!-- -->
...
GO_info_by_term_df_sig |> 
  ...
  geom_text(aes(label = sig,
            ...
            alpha = 1)
```
![](https://github.com/eriklarsen4/Endo/blob/main/vignettes/GO BP Bar Plot-1.png)<!-- -->
