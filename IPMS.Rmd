...
```{r Attach TMEM package, include = T, message = F, warning = F, echo = T}
packages <- c('TMEM', 'Endo', 'ggplot2', 'rstatix', 'forcats')
...
```{r IPMS data load, include = T, message = F, warning = F, echo = T}
data("IPMS_counts")
ALL_DF <- IPMS_counts
rm(IPMS_counts)
```
...
```{r Pre Crapome Candidates, eval = F, include = F, message = F, warning = F, echo = F}
## export data as csv to upload on CRAPome to find common contaminants
utils::write.table(
  Compiled_Candidate_List,
  'C:/Users/Erik/Desktop/Programming/R/Bio/Endo/PreCrapomeCandidateList.csv',
  row.names = F,
  col.names = F,
  sep =',')
```
...
```{r Write Crapome Hits to file, eval = F, include = F, message = F, warning = F, echo = F}
utils::write.table(
  Crapome_hits,
  'C:/Users/Erik/Desktop/Programming/R/Bio/Endo/PostCrapomeCandidateList.csv',
  row.names = F,
  col.names = F,
  sep = ',')
```
...
```{r Write GO Results DF to file, eval = F, include = F, message = F, warning = F, echo = F}
utils::write.table(
  GO_info_by_term_df_sig,
  'C:\\Users\\Erik\\Desktop\\Programming\\R\\Bio\\Endo\\IPMS_GO_DF.csv',
  row.names = F,
  col.names = T,
  sep = ',')
```
